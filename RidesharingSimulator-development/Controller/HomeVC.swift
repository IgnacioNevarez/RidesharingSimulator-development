    ...
    func textFieldDidBeginEditing(_ textField: UITextField) {
        if textField == destinationTextField {
            ...
            UIView.animate(withDuration: 0.2, animations: {
                ...
                self.destinationCircle.layer.borderColor = UIColor.init(red: 199/255, green: 0/255, blue: 0/255, alpha: 1.0).cgColor
            })
        }
    }
        ...
        if textField == destinationTextField {
            if destinationTextField.text == "" {
                UIView.animate(withDuration: 0.2, animations: {
                    ...
                    self.destinationCircle.layer.borderColor = UIColor.darkGray.cgColor
                })
            }
        }
    }
